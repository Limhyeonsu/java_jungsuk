...
class Apple4 extends Fruit4 {
	Apple4(String name, int weught){
		super(name, weught);
	}
}

class Grape4 extends Fruit4 {
	Grape4(String name, int weught){
		super(name, weught);
	}
}

class AppleComp implements Comparator<Apple4>{
	public int compare(Apple4 t1, Apple4 t2) {		//내림차순
		return t2.weight - t1.weight;
	}
}

class GrapeComp implements Comparator<Grape4>{
	public int compare(Grape4 t1, Grape4 t2) {		//내림차순
		return t2.weight - t1.weight;
	}
}

class FruitComp implements Comparator<Fruit4>{
	public int compare(Fruit4 t1, Fruit4 t2) {			//오름차순
